...
namespace Spawning.Pooling
{
	public class Pool : MonoBehaviour
	{
		...
		private ComponentCache _prefab = default;
		...
		public IComponentProvider GetObject(Vector3 position, Quaternion rotation)
		{
		...
		private readonly IDictionary<IDespawnable, IComponentProvider> _providersOfObjects =
			new Dictionary<IDespawnable, IComponentProvider>();
