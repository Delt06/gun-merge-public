...
namespace Spawning
{
	public sealed class DistanceDespawning : MonoBehaviour
	{
		...
		private float GetDistanceToTarget() => VectorUtils.GetDistanceXZ(transform.position, _spawnAnchor.Position);
